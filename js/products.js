...
const pathToProductsImages = `${pathToImages}/items`;
    ...
    return `
        <li class="products__item"">
            <div class="products__item-wrp">
                <img class="products__item-img" src="${pathToProductsImages}/${product.image}" alt="${product.name}">
                <div class="products__item-overlay"></div>
                <button class="products__item-btn" type="submit" data-productId="${product.id}"><svg class="products__item-icon" width="27"
